    ...
    <div class="login-form">
        ...
        <div class="group">
         ...
         <div class="group">
          ...
          <input id="pass" type="text" class="input" placeholder="Enter Firstname" name="username" required="true">
        </div>
        <div class="group">
          
         <label class="custom-file-upload">
            <input type="file" name="fileToUpload" id="files" hidden="hidden">
            <p style="color:white;background:<?php echo $_SESSION['color']?>" class="btn">Select Display Picture</p>
          </label>
        </div>
        <div class="group">
