      ...
      <div class="containers">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner" style="width:100%">  
            ...
            <p style="color:#1d52ba"> (Student Login.)</p>
             <?php  
                   if (isset($msg)) {
        ...
        ?>
            <form class="text-left form-validate" action="stulogin.php" method="post">
            ...
            </form><small>Forgot Password? </small><a href="studentforgot.php" class="signup">Click Here</a>
          </div>
