...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='SSS3'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'");
...
while ($r = mysqli_fetch_array($result)) {
  ...
  echo "<trstyle='color:#1d52ba;font-size:13px'><td style='color:grey'>".$id."</td><td>".$r['surname']."</td><td>".$r['firstname']."</td><td>".$r['lastname']."</td><td>".$r['email']."</td><td>".$r['parentNumber']."</td><td>".$r['admissionDate']."</td><td>".$r['date']."</td><td>".$r['time']."</td><td>
  </tr>";
...
echo "   </table>
 ...
 ?>          </div>
  ...
  <div class="col-md-6">
        ...
        <h5 class="mb-0">
           <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
          <span class="fa fa-angle-down mr-3"></span>All SSS3 Students (Edit Info)</button>      
          </h5>
    </div>
     <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion4">
                                            <div class="card-body">   
                    ...
                    <table class='table table-striped'>
                      ...
                      <thead>
                        ...
                        <th> S/N</th>
                          ...
                          <th>Report Card</th>
                          <th>Total Result(%)</th>
                          <th>Edit Grade(Subject)</th>
                          <th>Edit Position(Subject)</th>
                        </tr>
                      </thead>
                      <tbody>
