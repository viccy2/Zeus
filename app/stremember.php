  ...
  <body>
    <div class="page login-page">
      <div class="container">
        ...
        ?>
            <form class="text-left form-validate" action="strem.php" method="post">
              <div class="form-group-material">
                <input id="register-password" type="password" name="password" required data-msg="Please enter your new password" class="input-material">
                <label for="register-password" class="label-material"> New Password</label>
              </div>
               <div class="form-group-material">
                <input id="register-password" type="password" name="pass" required data-msg="Please confirm your password" class="input-material">
