...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='SSS1'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'");
...
echo "   </table>
 ...
 ?>          </div>
  ...
  <div class="col-md-6">
        ...
        <h5 class="mb-0">
           <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
          <span class="fa fa-angle-down mr-3"></span>All SSS1 Students (Edit Info)</button>      
          </h5>
    </div>
     <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion4">
                                            <div class="card-body">   
