        ...
        <div class="admin-menu">
          ...
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
           <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user"></i>Staff </a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
              <li><a href="adminstaffinfo.php"> <i class="fa fa-bar-chart"></i>Admin Staff </a></li>
    ...
    <div class="page">
      ...
      <section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display" style="color: #1d52ba"> All JSS1 Students    </h1>
          </header>
      ...
      <div class="row">
        ...
        <h5 class="mb-0">
          ...
          <span class="fa fa-angle-down mr-3"></span>All JSS1 Students(List)</button>      
          </h5>
    </div>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='JSS1'and school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'");
...
while ($r = mysqli_fetch_array($result)) {
  ...
  <a href='edit.php?id=$id'><input type='submit'name='edit data'value='Edit Profile'id='myBtn' class='add btn btn' style='background:#1d52ba;color:white'/></a></td>"."</td><td>
    <a href='delete.php?id=$id'><input type='submit'name='edit data'value='Delete'id='myBtn' class='add btn btn' style='background:#1d52ba;color:white;'/></a></td>"."</td>
  </tr>";
 ...
 ?>          </div>
      ...
      <section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display" style="color: #1d52ba"> All JSS2 Students    </h1>
          </header>
          <div class="accrodion-regular">                
         <div id="accordion4">
      <div class="container">
      <div class="row">
        ...
        <h5 class="mb-0">
           <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
          <span class="fa fa-angle-down mr-3"></span>All JSS2 Students(List)</button>      
          </h5>
    </div>
     <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion4">
                                            <div class="card-body">
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='JSS2'and school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
echo "   </table>
 ...
 ?>          </div>
        ...
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display" style="color: #1d52ba"> All JSS3 Students    </h1>
          </header>
          <div class="accrodion-regular">                
         <div id="accordion4">
      <div class="container">
      <div class="row">
        ...
        <h5 class="mb-0">
           <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
          <span class="fa fa-angle-down mr-3"></span>All JSS3 Students(List)</button>      
          </h5>
    </div>
     <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion4">
                                            <div class="card-body">
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='JSS3'and school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'and school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
echo "   </table>
 ...
 ?>          </div>
        ...
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display" style="color: #1d52ba"> All SSS1 Students    </h1>
          </header>
          <div class="accrodion-regular">                
         <div id="accordion4">
      <div class="container">
      <div class="row">
        ...
        <h5 class="mb-0">
           <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
          <span class="fa fa-angle-down mr-3"></span>All SSS1 Students(List)</button>      
          </h5>
    </div>
     <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion4">
                                            <div class="card-body">
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='SSS1'and school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='SSS2'and school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
while ($r = mysqli_fetch_array($result)) {
  ...
  echo "<tr style='color:#1d52ba;font-size:13px'><td style='color:grey'>".$id."</td><td>".$r['surname']."</td><td>".$r['firstname']."</td><td>".$r['lastname']."</td><td>".$r['email']."</td><td>".$r['parentNumber']."</td><td>".$r['admissionDate']."</td><td>".$r['date']."</td><td>".$r['time']."</td><td>
  <a href='sedit.php?id=$id'><input type='submit'name='edit data'value='Edit Profile'id='myBtn' class='add btn btn' style='background:#1d52ba;color:white'/></a></td>"."</td><td>
    <a href='delete.php?id=$id'><input type='submit'name='edit data'value='Delete'id='myBtn' class='add btn btn' style='background:#1d52ba;color:white;'/></a></td>"."</td>
...
echo "   </table>
 ...
 ?>          </div>
        ...
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display" style="color: #1d52ba"> All SSS3 Students    </h1>
          </header>
          <div class="accrodion-regular">                
         <div id="accordion4">
      <div class="container">
      <div class="row">
        ...
        <h5 class="mb-0">
           <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
          <span class="fa fa-angle-down mr-3"></span>All SSS3 Students(List)</button>      
          </h5>
    </div>
     <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion4">
                                            <div class="card-body">
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='SSS3'and school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
