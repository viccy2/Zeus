...
<a href="sss1.php" ><i class="fa fa-arrow-left fa-2x" style="width:40px;float:left;color:#1d52ba"></i></a>
  ...
  <div class="login-html">
    ...
    <div style="color:red;text-align:center;font-size:20px;">
      ...
      <?php
        $set=mysqli_query($con, "select * from sss_students_tb where student_id = '$chatid' and email='$emails'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'");
      ...
      $sets=mysqli_query($con, "select * from stotal_tb where student_id = '$chatid' and email='$emails'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'");
    ...
    <div class="login-form">
        ...
        <div class="group">
         <form action="sgra.php" method="post"> 
          <div class="group">
