  ...
  <body>
    <div class="page login-page">
      <div class="containers">
        ...
        ?>
            <form class="text-left form-validate" action="schlogin.php" method="post">
              <div class="form-group-material">
                ...
                <label for="register-email" class="label-material">School's Email Address</label>
              </div>
              <div class="form-group text-center">
                <input id="register" type="submit" value="Login" class="btn" style="background-color:#1d52ba;color:white">
              </div>
            </form><small>In need of an account? </small><a href="Zeus_school_registration_platform.php" class="signup">Create </a>
          </div>
