          ...
          <div class="form-inner" style="width:100%">  
            ...
            <p> (Admin Registration.)</p>
             <?php  
                 ...
                 <strong>Sorry!!!<br></strong> You should check in on some of those fields below.
                 ...
                 <strong>Sorry!!!<br></strong> You should check in on some of those fields below.
                  <a href='#' class='close' data-dismiss='alert' aria-label='Close'>
                   ...
                   ?>
            <form class="text-left form-validate" action="schooladminreg.php" method="post" enctype="multipart/form-data">
              <div class="form-group-material">
                <input id="register-username" type="text" name="surname" required data-msg="Please enter your surname" class="input-material">
                <label for="register-username" class="label-material">Surname</label>
              </div>
               <div class="form-group-material">
                <input id="register-username" type="text" name="name" required data-msg="Please enter your Lastname" class="input-material">
              ...
              <div class="form-group-material">
                <input id="register-username" type="text" name="phone" required data-msg="Please enter your Contact" class="input-material">
                <label for="register-username" class="label-material">Contact</label>
              </div>
              <select data-placeholder="Choose a Country..." style="color:#0a4981" class="chosen-select form-control" tabindex="-1" name="country">
            ...
            <p style="background-color:#1d52ba;color:white" class="btn">Select Profile Picture</p>
              ...
              <div class="form-group text-center">
                <input id="register" type="submit" value="Register" class="btn" style="background-color:#1d52ba;color:white">
              </div>
