  ...
  <div class="login-html">
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked>
     <div style="color:red;text-align:center;font-size:20px;"> <?php  
                   ...
                   ?></div>
    <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab" style="text-align:center;color:white;">Enter New Password</label>
    <div class="login-form">
        ...
        <div class="group">
         ...
         <div class="group">
          ...
          <input id="pass" type="password" class="input" placeholder="New Password" name="password" required="true">
        </div>
         <div class="group">
          
          <input id="pass" type="password" class="input" placeholder="Confirm New Password" name="passwor" required="true">
        </div>
        <div class="group">
