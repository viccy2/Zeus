...
<div class="col-md-5 about-bottoml-agileits">
    ...
    <div class="col-md-7 about-bottomr-agileits">
      <div class="appointment_head">
        <h3>Student Subject Platform(Junior Class) </h3>
      </div>
        ...
        <h6>Subjects Offered</h6>
         <input class="name" type="text" name="subj1" placeholder="Subject" required="">
           ...
           <input class="name" type="text" name="subj10" placeholder="Subject" required="">
            <input class="name" type="text" name="subj11" placeholder="Subject9">
           <input class="name" type="text" name="subj12" placeholder="Subject" >
           <input class="name" type="text" name="subj13" placeholder="Subject" >
            <input class="name" type="text" name="subj14" placeholder="Subject" >
            <input class="name" type="text" name="subj15" placeholder="Subject" >
