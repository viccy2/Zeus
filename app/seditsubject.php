...
<body>
  <?php 
  require 'dc.php';  
 $info=mysqli_query($con,"select * from sss_students_tb where student_id='$chatid'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'");
...
<a href="sss1.php" ><i class="fa fa-arrow-left fa-2x" style="width:40px;float:left;color:#1d52ba"></i></a>
  ...
  <div class="login-html">
    ...
    <div class="login-form">
        ...
        <div class="group">
         <form action="seditsbj.php" method="post">          
        <div class="group">
