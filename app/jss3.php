...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from student_tb where class='JSS3'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'");
...
echo "   </table>
 ...
 ?>          </div>
  ...
  <div class="col-md-6">
        ...
        <h5 class="mb-0">
           <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
          <span class="fa fa-angle-down mr-3"></span>All JSS3 Students (Edit Info)</button>      
          </h5>
    </div>
     <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion4">
                                            <div class="card-body">   
...
while ($r = mysqli_fetch_array($result)) {
  ...
  <a href='total.php?id=$id' ><input type='submit'name='delete data'value='Total Result'id='myBtn' class='del btn btn'  style='background:#1d52ba;color:white';/></a></td>
  <td> <a href='next.php?id=$id' ><input type='submit'name='delete data'value='View Result'id='myBtn' class='del btn btn'  style='background:#1d52ba;color:white';/></a></td>
  </tr>";
