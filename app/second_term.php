...
$yet = mysqli_query($con, "select * from sss_students_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'");
 ...
 $result = mysqli_query($con, "select * from sreport_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and type='C.A Test1' and term='2nd Term'");
 while ($r = mysqli_fetch_array($result)) {
  ...
  $r['subject11'];
   ...
   $results = mysqli_query($con, "select * from sreport_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and type='C.A Test2' and term = '2nd Term'");
 while ($re = mysqli_fetch_array($results)) {
  ...
  $re['subject11'];
   ...
   $resul = mysqli_query($con, "select * from sreport_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and type='Exam' and term = '2nd Term'");
 while ($rest = mysqli_fetch_array($resul)) {
  ...
  $rest['subject11'];
    ...
    $sets = mysqli_query($con, "select * from stotal_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and term = '2nd Term'");
 while ($t = mysqli_fetch_array($sets)) {
  ...
  $t['grade'];
   ...
   $grade = mysqli_query($con, "select * from sgrade_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'and term = '2nd Term'");
 while ($gra = mysqli_fetch_array($grade)) {
  ...
  $gra['subject11'];
    ...
    $position = mysqli_query($con, "select * from sposition_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'and term = '2nd Term'");
...
<div class='table-responsive' style='width:100%'>
  <div class='h3 text-center' style='color:$t;margin-top:50px'> 2nd Term </div>
...
echo "</table>
 ...
 $result = mysqli_query($con, "select * from report_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and type='C.A Test1' and term = '2nd Term'");
 while ($r = mysqli_fetch_array($result)) {
  $id = $r ['report_id'];
  $r['total'];
  $r['subject1'];
  ...
  $r['subject15'];
   ...
   $results = mysqli_query($con, "select * from report_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and type='C.A Test2' and term = '2nd Term'");
 while ($re = mysqli_fetch_array($results)) {
  $re['total'];
  $re['subject1'];
  $re['subject2'];
  ...
  $re['subject15'];
   ...
   $resul = mysqli_query($con, "select * from report_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and type='Exam' and term = '2nd Term'");
 while ($rest = mysqli_fetch_array($resul)) {
  $rest['total'];
  $rest['subject1'];
  $rest['subject2'];
  ...
  $rest['subject15'];
    ...
    $sets = mysqli_query($con, "select * from total_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]' and term = '2nd Term'");
 while ($t = mysqli_fetch_array($sets)) {
  $t['total'];
  $t['subject1'];
  $t['subject2'];
  ...
  $t['position'];
   ...
   $grade = mysqli_query($con, "select * from grade_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'and term = '2nd Term'");
 while ($gra = mysqli_fetch_array($grade)) {
  $gra['subject1'];
  $gra['subject2'];
  $gra['subject3'];
  ...
  $gra['subject15'];
    ...
    $position = mysqli_query($con, "select * from position_tb where email='$_SESSION[emails]'and school_id = '$_SESSION[schools_id]' and school_mail='$_SESSION[schools_email]'and term = '2nd Term'");
 while ($pos = mysqli_fetch_array($position)) {
  $pos['subject1'];
  $pos['subject2'];
  $pos['subject3'];
