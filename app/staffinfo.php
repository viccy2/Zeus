          ...
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
           <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user"></i>Staff </a>
             ...
             <li><a href="adminstaffinfo.php"> <i class="fa fa-bar-chart"></i> Admin Staff </a></li>
              <li><a href="#"> <i class="fa fa-bar-chart"></i>Staff </a></li>
    ...
    <div class="page">
      ...
      <section>
        ...
        <?php echo "<img src='".$_SESSION['admin_passport']."'  style='width:100px;height:100px;border-radius: 50%' >";?>
          ...
          <!-- Page Header-->
            <header> 
            <h1 class="h3 display"> All Staff       </h1>
          </header>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from staffs_tb where school_id = '$_SESSION[school_id]' and school_mail='$_SESSION[school_email]'");
